...
<?php if ($GLOBALS['valid']) : ?>
    ...
    <section class="card">
        ...
        <button  type="button" id="final_copy" name="final_copy" value="copy" class="next_button btn btn-primary"><a class="thisa"><i class="fas fa-copy"></i>   Copy Google URL</a></button>
        <button  type="button" id="final_open" name="final_open" value="open" class="next_button btn btn-primary"><a class="thisa" href="#" id="url_button"><i class="fas fa-map-marked"></i>   Get Directions</a></button>
